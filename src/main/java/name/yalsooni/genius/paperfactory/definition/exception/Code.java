package name.yalsooni.genius.paperfactory.definition.exception;
...
public interface Code {
    ...
    String G_010_1001 = "[G-010-1001] 입력 데이터 수행 중 오류 입니다.";
    String G_010_2001 = "[G-010-2001] 출력 데이터 수행 중 오류 입니다.";

    String G_010_3001 = "[G-010-3001] 초기화 오류 입니다.";
}
